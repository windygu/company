...
public class MusicTools {
	...
	public String post_checksmsinitreturn_req(String md5imsi, String appid, String pubKey, String packageName, String excode, String UA,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"I1.0\"";
		if (!excode.equals(""))
			Authorization += ",excode=\"" + excode + "\"";
		PrintWriter out = null;
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/checksmsinitreturn");
		...
		logBuff.append("post_checksmsinitreturn_req:\n" + result);
		return result;
	}
	
	public String post_query_req(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String serviceId,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/cp/query");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version=\'1.0\' encoding=\'UTF-8\'?><request><serviceId>" + serviceId + "</serviceId></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
	...
	public String post_serviceEx_req(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String contentId,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/cp/serviceEx");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version=\'1.0\' encoding=\'UTF-8\'?><request><contentId>" + contentId + "</contentId></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		logBuff.append("post_serviceEx_req:\n" + result);
		return result;
	}
	
	public String post_crbt_info(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String musicId,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/crbt/info");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version='1.0' encoding='UTF-8'?><request><musicId>" + musicId + "</musicId></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		logBuff.append("post_crbt_info_req:\n" + result);
		return result;
	}
	
	public String post_search_chart_list(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/search/chart/list");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version='1.0' encoding='UTF-8'?><request><pageNumber>1</pageNumber><numberPerPage>30</numberPerPage></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		//logBuff.append("post_search_chart_list_req:\n" + result);
		return result;
	}
	
	public String post_search_music_listbychart(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String chartCode,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/search/music/listbychart");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version='1.0' encoding='UTF-8'?><request><chartCode>" + chartCode + "</chartCode><pageNumber>1</pageNumber><numberPerPage>30</numberPerPage></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		//logBuff.append("post_search_music_listbychart_req:\n" + result);
		return result;
	}
	
	public void get_lyric(String url,StringBuffer logBuff) {
		InputStream in = null;
		try {
			...
			conn.setRequestProperty("accept", "*/*");
			conn.setRequestProperty("connection", "Keep-Alive");
			conn.setRequestProperty("user-agent", "SAMSUNG-GT-I9018_TD/1.0 Android/2.2.2 Release/12.15.2010 Browser/AppleWebKit533.1 Profile/MIDP-2.1 Configuration/CLDC-1.1");
			conn.setRequestProperty("Accept-Encoding", "gzip");
			conn.setConnectTimeout(10000);
			conn.setReadTimeout(30000);
			conn.connect();
	...
	public String post_song_policy(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String musicId,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/song/policy");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version='1.0' encoding='UTF-8'?><request><musicId>" + musicId + "</musicId><resource>000009</resource><resource>020007</resource><resource>020022</resource></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		logBuff.append("post_song_policy_req:\n" + result);
		return result;
	}
	
	public String post_user_query(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/user/query");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
		...
		logBuff.append("post_user_query_req:\n" + result);
		return result;
	}
	
	public String post_ring_policy(String md5imsi, String appid, String pubKey, String packageName, String excode, String definedseq, String UA, String musicId,StringBuffer logBuff) {
		String result = "";
		String Authorization = "OEPAUTH realm=\"OEP\",IMSI=\"" + md5imsi + "\",appID=\"" + appid + "\",pubKey=\"" + pubKey + "\",netMode=\"WIFI\",packageName=\"" + packageName + "\",version=\"M1.3\",excode=\"";
		if (!excode.equals(""))
			Authorization += excode;
		...
		BufferedReader in = null;
		try {
			URL realUrl = new URL("http://218.200.227.123:94/sdkServer/1.0/ring/policy");
			URLConnection conn = realUrl.openConnection();
			conn.setRequestProperty("Authorization", Authorization);
			conn.setRequestProperty("Accept", "*/*");
			conn.setRequestProperty("Content-Type", "*/*");
			...
			conn.setReadTimeout(30000);
			out = new PrintWriter(conn.getOutputStream());
			out.print("<?xml version='1.0' encoding='UTF-8'?><request><musicId>" + musicId + "</musicId><resource>000018</resource><resource>999992</resource></request>");
			out.flush();
			in = new BufferedReader(new InputStreamReader(conn.getInputStream()));
			String line;
			while ((line = in.readLine()) != null) {
		...
		logBuff.append("post_ring_policy_req:\n" + result);
		return result;
	}
	
	public String generate_enreq1(String ctype, String appid, String SubscriberId, String DeviceId, String encodeCID, String rand16Num, String TimeStamp, String cpid, String contentId, String chid, String sdksessionid, String apkstatus, String requestTime, String cpparam,byte[] Key1, byte[] Key2,StringBuffer logBuff) {
		...
		result = encode_RequestResponse("aZ8RyZRWxcJno2cBcwQDAHYjmZoOC5Gi", result);
		// result = "en_sessionreq=" + URLEncoder.encode(result);
		return result;
	}
	
	public String generate_enreq2(String ctype, String appid, String SubscriberId, String DeviceId, String encodeCID, String rand16Num, String TimeStamp, String cpid, String contentId, String chid, String sdksessionid, String apkstatus, String requestTime, String cpparam,byte[] Key1, byte[] Key2,StringBuffer logBuff) {
	...
	public String post_getSession1(String SubscriberId, String DeviceId, String Signature, String enreq,StringBuffer logBuff) {
		String result = "";
		PrintWriter out = null;
		BufferedReader in = null;
		try {
		...
		logBuff.append("getSession1:\nresult:\n" + result);
		return result;
	}
	
	public String post_getSession2(String SubscriberId, String DeviceId, String Signature, String enreq,StringBuffer logBuff) {
		String result = "";
		PrintWriter out = null;
		BufferedReader in = null;
		try {
	...
	public  String generateEncodeCID(String cid) {
		...
		v82 = v81 + v79 + v78;
		v83 = ROR4(v76 + v26 + 1735328473 + ((v82 ^ (v79 + v78)) & v78 ^ (v79 + v78)), 18);
		v84 = v83 + v82;
		v85 = ROR4(v78 + v41 - 1926607734 + ((v79 + v78) & (v84 ^ v82) ^ v82), 12);
		v86 = v85 + v84;
	...
	public  String generateMuisicLoginSms(String md5imsi, String appid, String imei, String timeStamp, String excode, byte[] aesKey,StringBuffer logBuff) {
		String result = "CMO_S=" + AESEncrypt((md5imsi + appid + imei + "@" + timeStamp).getBytes(), aesKey) + "@I1.0";
		if (!excode.equals(""))
			result += "@" + excode;

		logBuff.append("sms addresss:\n1065843601\nsms content:\n" + result);
		logBuff.append("am start -a android.intent.action.SENDTO -d sms:1065843601 --es sms_body " + "\"" + result + "\"");
		return result;
	}
	...
	public  String getContextByTag(String context, String tag,StringBuffer logBuff) {
		String result = "";
		try{
	...
	public String generate_enreq3(String ctype, String appid, String SubscriberId, String DeviceId, String encodeCID, String rand16Num, String TimeStamp, String cpid, String contentId, String chid, String sdksessionid, String apkstatus, String requestTime, String session, String transId, String itemId, String itemPrice, String itemSafeLevel, String itemMethod, String itemExt, String cpparam,byte[] Key1, byte[] Key2,StringBuffer logBuff) {
	...
	public String post_doCharge(String SubscriberId, String DeviceId, String Signature, String enreq, String ctype, String transId,StringBuffer logBuff) {
		String result = "";
		PrintWriter out = null;
		BufferedReader in = null;
		try {
		...
		logBuff.append("doCharge:\nresult:\n" + result);
		return result;
	}
	
	public void downloadByURL(String url,StringBuffer logBuff) {
		InputStream in = null;
