 ...
 * @date 2016-3-24
 */
public class MiguGameLogEvent2 {
	...
	private static String apiVersion = "2.3";
	private static String gameType = "6";
	...
	public void gameLogEvent4(long logInvokeTime, String webSecond,
		...
		String logdata4 = logdata
				...
				+ itemName
				+ ",payName@����֧��,eventId@E0002_0,policy5Tel@,eventType@2,chargeTimes@,chargeType@0,itemCode@"
				+ consumeCode;
	...
	public String[][] getHeaders(String Signature) {

		return new String[][] { { "apiVersion", apiVersion }, { "imei", imei },
				{ "imsi", imsi }, { "OS_TYPE", "1" },
				{ "platform", "Android" }, { "Response-Type", "xml" },
				{ "sdkSessionId", sdkSessionId }, { "SDKVersion", sdkversion },
				{ "signer", Signature },
				{ "X-OF-Key", "Signature-OF-RSAUtils" },
				{ "X-OF-Signature", Signature } };

	}

	public static void main(String[] args) {
		// TODO
		// new MiguGameLogEvent2().queryConfiguration();
		// Random-Code=4402&Encrypt-IMSI=460007042977455&Encrypt-IMEI=356260056739725&contentId=609816034965&channelId=42025000&tokenType=0
		String imsi = "460007042977455";
		String rand4num = "4402";
		String imei = "356260056739725";
		String contentId = "609816034965";
		String channelId = "42025000";
		String tokenType = "0";
		String cpId = "796098";
		String gameId = "";
		String gameType = "1";
		String needTel = "1";
		String ua = "GT-I9300";
		String sdkSessionId = "aa3RHKHee2d3";
		String sdkVersion = "26002";
		...
		MiguGameLogEvent2 event = new MiguGameLogEvent2();
		event.init(sdkSessionId, sdkVersion, cpId, contentId, channelId, imei,
				imsi, mac, BRAND, MODEL);
		long startTime = System.currentTimeMillis();
		event.QueryConfigPolicy();
		event.queryConfiguration();
		event.queryThirdPayInfo();
		long logInvokeTime = System.currentTimeMillis();
		String webSecond = (logInvokeTime - startTime) / 1000 + "";
		event.gameLogEvent1(logInvokeTime, webSecond);

		event.QuerySafechargeRuleV2();
		event.post_egsb_verification_checkSdkUpdate("1");
		event.queryAll();
		event.switches();
		event.getUpdateUrl("com.pan08.whiteStar03JDzhuazhu");

		logInvokeTime = System.currentTimeMillis();
		webSecond = (logInvokeTime - startTime) / 1000 + "";

		event.gameLogEvent2(logInvokeTime, webSecond);

		LoginSms.generateLoginSMS(imsi, rand4num, imei, osVersion, channelId,
				contentId, BRAND, MODEL, netstat, sdkVersion, sdkSessionId, "");

		String andSynchToken = event.getAndSynchToken(rand4num);

		String status = Common.getValue(andSynchToken, "<status>", "</status");
		if (!status.equals("0")) {
			System.out.println("��¼ʧ��");
			return;
		}

		String userToken = Common.getValue(andSynchToken, "<userToken>",
				"</userToken");
		String loginType = Common.getValue(andSynchToken, "<loginType>",
				"</loginType");
		String tokenTel = Common.getValue(andSynchToken, "<tokenTel>",
				"</tokenTel");

		String loginNewClient = event.loginNewClient(ua, userToken, loginType);
		status = Common.getValue(loginNewClient, "<status>", "</status");
		if (!status.equals("0")) {
			System.out.println("��¼ʧ��2");
			return;
		}
		String uid = Common.getValue(loginNewClient, "<uid>", "</uid");
		String ub = Common.getValue(loginNewClient, "<ub>", "</ub");
	 ...
	 * ����
	 */
	public String queryThirdPayInfo() {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+"
				+ "channelId=" + channelId + "&contentId=" + contentId,
				"Signature-OF-Secret&");
	 ...
	 * ����
	 */
	public String QuerySafechargeRuleV2() {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+",
				"Signature-OF-Secret&");
	 ...
	 * type 1
	 */
	public String post_egsb_verification_checkSdkUpdate(String type) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+type=" + type
				+ "&versionCode=" + sdkversion, "Signature-OF-Secret&");

		String url = "http://drm.cmgame.com/egsb/verification/checkSdkUpdate";
		String headers[][] = getHeaders(Signature);
		String content = "versionCode=" + sdkversion + "&type=" + type
	...
	public String switches() {
		...
		String headers[][] = getHeaders(Signature);
		String content = "contentId=" + contentId + "&channelId=" + channelId
				+ "&tel=&ua=" + URLEncoder.encode(model) + "&gameType="
				+ gameType;
		String result = httpConnect(url, headers, content, null);
		return result;
	}
	...
	public String getUpdateUrl(String packageName) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+channelId="
				+ channelId + "&clientType=2&contentId=" + contentId
	...
	public String getAndSynchToken(String rand4num) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+"
				+ "Encrypt-IMEI=" + imei + "&Encrypt-IMSI=" + imsi
				+ "&Random-Code=" + rand4num + "&channelId=" + channelId
				+ "&contentId=" + contentId + "&tokenType=" + "0",
				"Signature-OF-Secret&");

		String url = "http://drm.cmgame.com/egsb/token/getAndSynchToken?Random-Code="
				+ rand4num
				+ "&Encrypt-IMSI="
				+ imsi
				+ "&Encrypt-IMEI="
	...
	public String loginNewClient(String ua, String userToken, String loginType) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+"
				+ "channelId=" + channelId + "&contentId=" + contentId
				+ "&cpId=" + cpId + "&cpparam=" + "&gameId=" + "&gameType="
				+ "1" + "&loginType=" + loginType + "&needTel=" + "1"
				+ "&tokenType=0" + "&ua=" + ua + "&userToken=" + userToken,
				"Signature-OF-Secret&");

		String url = "http://drm.cmgame.com/egsb/access/loginNewClient";
		String headers[][] = getHeaders(Signature);
		String content = "loginType=2&gameType=1&gameId=&cpId=" + cpId
				+ "&contentId=" + contentId + "&channelId=" + channelId
				+ "&userToken=" + userToken
				+ "&tokenType=0&needTel=1&cpparam=&ua=" + ua;
		String result = httpConnect(url, headers, content, null);
		return result;
	}
	...
	public String queryAnnouncement(String uid, String ub, String type) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+channelId="
	...
	public String queryCardMarket(String uid, String ub) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+channelId="
	...
	public String subscribeAuth(String uid, String ub) {
		String Signature = getHmacSHA1(
	...
	public String userTransLogin(String uid, String ub) {
		String Signature = getHmacSHA1("+Signature-OF-Secret+POST+channelId="
