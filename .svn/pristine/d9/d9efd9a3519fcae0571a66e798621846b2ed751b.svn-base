 ...
 * @date 2016-09-08
 */
public class Game2DataLinstenerThreadDao extends JobThread{
	private Logger logger = Logger.getLogger(Game2DataLinstenerThreadDao.class);
...
//						"INNER JOIN spinfo.sp_product_crack_info AS b ON a.spProductId=b.spProductId " +
						...
						"where infoState=0 AND supportState<1000001" + " " +
							...
							"AND supportType='game.GameSms20'"+
				...
				ArrayList<Object> list=dt.executeQuery(sql, SupportExecLog.class, Game2DataLinstenerThreadDao.class);
				taskNum=list.size();
